<div id="cuerpo">
	...
	<table id='dataTable' align='center'>
		<tr>
			<th colspan="8">Editar Observación Comercial</th>
		</tr>
		...
		<tr>
			...
			<td width="75%">
				<?php echo form_textarea(array('name' => 'obs_detalle', 'value' => $obs_detalle, 'cols' => '110', 'rows' => '10', 'class' => 'caja')); ?>
			</td>
		</tr>
        <tr><td colspan="8">&nbsp;</td></tr>
		<tr>
	...
	<?php echo form_hidden('obs_id', $obs_id); ?>
	<?php echo form_close(); ?>
	<br>
